...
(function(){
    ...
    function fight(){
        ...
        alert(playerOneName [0]+ ":" +playerOneName[2]+ "START" +playerTwoName[0]+ ":" +playerTwoName[2]);

        for(var i=0; i < 10; i++){
            //code will go here

            var minDamage1 = playerOneName[1] *.5;
            var minDamage2 = playerOneName[1] *.5;
            var f1 = Math.floor(Math.random()*(playerOneName[1]-minDamage1)+minDamage1);
            var f2 = Math.floor(Math.random()*(playerTwoName[1]-minDamage2)+minDamage2);
            //console.log(f1);
            //console.log(f2);
            ...
            console.log(playerOneName[0]+":"+playerOneName[2]+ "" +playerTwoName+":"+playerTwoName[2])
    ...
    function winnerCheck(){
        ...
        if(playerOneName[2]<1 && playerTwoName[2]<1){
            result = "You Both Die";
        }else if(playerOneName[2]<1){
            result = playerTwoName+"WINS!!!"
        }else if(playerTwoName[2]<1){
